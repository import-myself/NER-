...
def collate_fn(batch):  # 需要统一序列的长度
...
def main():
    ...
    train_word_data, train_tag_data = word_tag_id(train_words_list, train_tags_list, word2id, tag2id)
    ...
    for word, tag in zip(train_word_data, train_tag_data):
